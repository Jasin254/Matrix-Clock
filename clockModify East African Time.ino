...
char ssid[] = "Faiba";                    // your network SSID (name)
char pass[] = "nN0v@t3!";                    // your network password
...
const char* ntpServerName = "https://www.timeanddate.com/worldclock/kenya/nairobi";     //NTP服务器域名
